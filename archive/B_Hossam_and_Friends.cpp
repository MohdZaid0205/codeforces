...
std::vector<long long int> arr = std::vector<long long int>(n, n);
std::vector<long long int> brr = std::vector<long long int>(n, -1);
for (long long int i = 0; i < q; i++){
    long long int a, b;
    std::cin >> a >> b;
    chmin(arr[vmin(a, b) - 1], vmax(a,b)-1);
    chmax(brr[vmax(a, b) - 1], vmin(a,b)-1);
}
