...
std::vector<long long int> S = std::vector<long long int>(n);
for (long long int i = 0; i < n; i++){ std::cin >> S[i]; }

std::vector<std::vector<long long int>> NM;
for (long long int i = 0; i < n; i++){
    std::vector<long long int> M(m, 0);
