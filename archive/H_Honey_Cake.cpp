...
std::vector<long long int> facW = getFactors(w);
std::vector<long long int> facH = getFactors(h);
std::vector<long long int> facD = getFactors(d);
bool found = false;

for (long long int i:facW){   
    for (long long int j:facH){
